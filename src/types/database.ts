    ...
    Tables: {
      ...
      appeals: {
        Row: {
          id: string;
          user_id: string;
          item_type: "ai_summary" | "reputation_badge";
          item_key: string;
          item_label: string;
      ...
      editorial_release_cursor: {
        Row: {
          ...
          last_published_release_slug: string | null;
      ...
      editorial_release_drafts: {
        Row: {
          ...
          features: string[];
          notes: string | null;
          target: "bot" | "channel" | "both" | null;
          schedule_at: string | null;
          source_commits: string[];
          source_status_lines: string[];
          generation_context: Json;
          published_release_slug: string | null;
          created_by: string;
