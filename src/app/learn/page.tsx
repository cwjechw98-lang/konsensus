    ...
    <div className="mx-auto max-w-5xl px-4 py-10">
      <div className="mb-6">
        <PageContextCard
          ...
          title="Образовательный слой переводит спор в управляемый навык"
          description="Здесь собраны короткие материалы без длинной LMS. Задача простая: после спора вы видите следующий полезный шаг и быстро добираете недостающий навык."
          bullets={[
            "5-6 коротких материалов вместо длинного курса",
            "Персональные рекомендации по AI-профилю",
            "Отметка прохождения без лишней бюрократии",
          ]}
          tone="cyan"
        />
      </div>
      ...
      <div className="mb-6">
        <EducationRecommendationsPanel
          ...
          description="Первый экран отдаёт самые полезные материалы под ваш текущий профиль и стиль последних споров."
        />
      </div>
