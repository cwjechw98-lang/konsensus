        ...
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-400">
              Здесь ваши текущие и архивные споры.
            </p>
          </div>
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <Link
              href="/dispute/join"
              data-tour="join-code"
              className="glass rounded-lg px-4 py-2 text-sm font-medium text-gray-300 transition-colors hover:text-white active:scale-[0.98]"
            >
              По коду
            </Link>
            <Link
              ...
              className="btn-ripple rounded-lg bg-purple-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-purple-500 active:scale-[0.98]"
            >
              + Новый спор
            </Link>
          </div>
          ...
          <>
            ...
            <div className="mt-5">
              <EducationRecommendationsPanel
                ...
                description="Один материал, который можно прочитать за пару минут."
              />
            </div>
          </>
        )}
