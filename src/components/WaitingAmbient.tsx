...
const AMBIENT_LINES = {
  dispute: [
    "Пауза нужна не для пустоты: ИИ собирает контекст и удерживает разговор в спокойной рамке.",
    "Пока оппонент думает, можно заметить не только разницу позиций, но и точки возможного сближения.",
    "Иногда самый полезный следующий ход рождается не в спешке, а в короткой паузе.",
  ],
  arena: [
    "Открытый диспут тоже держится на точном темпе: спокойная пауза лучше шумной реакции.",
    "Пока следующий ход не сделан, система удерживает тему и помогает не сорваться в перепалку.",
    "Даже в публичном формате важен не эффект, а ясная мысль и аккуратный следующий шаг.",
  ],
} as const;
      ...
      <div className="ambient-stage h-36 rounded-xl relative overflow-hidden bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.14),transparent_45%),radial-gradient(circle_at_bottom,rgba(59,130,246,0.12),transparent_50%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))]">
        ...
        <div className="absolute inset-x-4 bottom-4 z-10">
          <p className="text-[11px] uppercase tracking-[0.22em] text-gray-500 mb-2">
            {variant === "arena" ? "Пауза в открытом диспуте" : "Момент ожидания"}
          </p>
