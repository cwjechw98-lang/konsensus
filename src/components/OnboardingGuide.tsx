...
const STEPS: GuideStep[] = [
  {
    ...
    previewItems: [
      ...
      "Арена — live battle и наблюдение",
      "События — публичная движуха проекта",
      "Профиль — ачивки, архив, AI-профиль",
    ],
  ...
  {
    eyebrow: "Раздел 3",
    title: "Арена — открытые live-битвы",
    desc: "Это отдельная публичная зона: вызовы, spectator-mode, observer chat и живой ход спора. Арена не заменяет ваши личные споры, а дополняет их.",
    previewTitle: "Что будет внутри",
    previewItems: [
      "Открытые battle",
      "Spectator-view",
      "Observer chat",
      "Live-наблюдение за ходом спора",
    ],
