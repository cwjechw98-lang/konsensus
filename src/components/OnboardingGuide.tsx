...
const STEPS: GuideStep[] = [
  {
    ...
    previewItems: [
      ...
      "Арена — открытые диспуты и наблюдение",
      "События — открытая активность платформы",
      "Профиль — сигналы диалога, архив, ИИ-профиль",
    ],
  ...
  {
    eyebrow: "Раздел 3",
    title: "Арена — открытые диспуты",
    desc: "Это отдельная публичная зона: открытые темы, режим наблюдения и живой ход обсуждения. Арена не заменяет личные споры, а даёт наблюдаемый публичный слой.",
    previewTitle: "Что будет внутри",
    previewItems: [
      "Открытые диспуты",
      "Режим наблюдения",
      "Публичные комментарии",
      "Наблюдение за ходом диалога",
    ],
  ...
  },
  {
    ...
    desc: "Этот раздел не про вступление в спор, а про наблюдение за жизнью платформы: публичные дискуссии, открытые темы и заметные движения внутри проекта.",
    previewTitle: "Что будет внутри",
    previewItems: [
      "Публичные споры",
      "Открытые темы",
      "События арены",
      "Что заметно прямо сейчас",
    ],
  ...
  },
  {
    ...
    desc: "В профиле хранятся ваш AI-профиль, архив, сигналы качества диалога и настройки уведомлений. Это рабочий контекст, а не игровая витрина.",
    previewTitle: "Что будет внутри",
    previewItems: [
      "Сигналы качества диалога",
      "AI-профиль и стиль диалога",
      "Архив споров",
