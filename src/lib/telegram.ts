...
export async function notifyArgumentReceived(
  ...
  return upsertDisputeLiveNotification({
    chatId,
    disputeId,
    text: `💬 <b>${senderName}</b> добавил новый аргумент\n\nТема: <i>${disputeTitle}</i>\nТекущий раунд: ${round}`,
...
const BOT_JOKES = [
  ...
  "⚡ Сильный участник отличается не громкостью, а умением слушать.",
  "🎯 Лайфхак: начните аргумент словами «Я понимаю твою позицию, и при этом...» — это снижает напряжение.",
  "🌊 Цель спора — не победа, а ясность и рабочее решение.",
  "🔥 Самые длинные споры часто возникают вокруг самых простых бытовых решений.",
  "🎪 ИИ-медиатор уже видел сотни диалогов. Чем конкретнее мысль, тем полезнее его подсказка.",
  "🧘 Мудрость: если вы не можете объяснить позицию оппонента — вы ещё не поняли спор.",
  "🏆 Самый ценный результат — не победа, а момент, когда стороны начинают слышать друг друга.",
];
