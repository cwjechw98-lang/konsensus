...
export const ACHIEVEMENTS = {
  ...
  // ── Прогресс ──
  three_rounds:      { title: "Марафонец",          desc: "Завершите спор с тремя и более раундами",    points: 20,  icon: "🔥",  category: "progress" },
  ...
  five_disputes:     { title: "Опытный",            desc: "Участвуйте в пяти спорах",                  points: 50,  icon: "🏆",  category: "progress" },
  ten_disputes:      { title: "Мастер",             desc: "Участвуйте в десяти спорах",                points: 100, icon: "👑",  category: "progress" },
  twenty_disputes:   { title: "Легенда арены",      desc: "Участвуйте в двадцати спорах",              points: 200, icon: "⭐",  category: "progress" },
  ...
  // ── Арена ──
  first_challenge:   { title: "Вызов брошен",       desc: "Создайте свой первый вызов на арене",        points: 20,  icon: "⚔️",  category: "arena" },
  challenge_accepted:{ title: "Вызов принят",       desc: "Примите вызов на арене",                     points: 20,  icon: "🛡️",  category: "arena" },
  arena_veteran:     { title: "Ветеран арены",      desc: "Участвуйте в 5 вызовах на арене",           points: 60,  icon: "🏟️",  category: "arena" },
  ...
  got_reactions:     { title: "Народная любовь",     desc: "Получите 10 реакций на ваш спор",            points: 25,  icon: "❤️",  category: "social" },
  ...
  weekend_warrior:   { title: "Воин выходного дня", desc: "Создайте спор в субботу или воскресенье",     points: 10,  icon: "🗓️",  category: "special" },
  ...
  speed_resolution:  { title: "Блицкриг",           desc: "Завершите спор менее чем за 1 час",           points: 30,  icon: "⏱️",  category: "special" },
} as const;
...
export const CATEGORY_LABELS: Record<AchievementCategory, { label: string; icon: string }> = {
  ...
  special:   { label: "Специальные",     icon: "✨" },
};
