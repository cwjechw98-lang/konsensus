...
**Фаза 8–10 (Социальный слой + ИИ-углубление + профиль)** — расширена. Добавлены матчинг по темам, уникальные AI-достижения, Telegram-first вход через Mini App и раундовая арена.
