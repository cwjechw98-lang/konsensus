...
Следующий шаг:
- пройти уже сами карточки споров на мобильном;
- упростить архивный reminder-слой в `DashboardDisputeCard`;
- проверить, нужен ли отдельный короткий cleanup для mobile tabs в профиле.
