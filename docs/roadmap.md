...
- [x] Telegram-бот (уведомления, привязка, Mini App, автоочистка, push о вызовах)
...
- [ ] ИИ-генерируемые уникальные достижения
- [ ] Pre-submission анализ черновика ("это может усилить конфликт")
