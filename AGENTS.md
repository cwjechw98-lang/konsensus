...
## Правило ведения плана в диалоге
- Перед началом нового пакета работ коротко напоминать:
  - какой сейчас основной план;
  - что из него уже выполнено;
  - какой следующий шаг выполняется прямо сейчас
- Если пользователь предлагает боковую идею, сначала соотнести её с текущим основным планом и явно сказать:
  - входит ли она в текущий пакет;
  - переносится ли она в отдельный rollout/бэклог;
  - не ломает ли она согласованную последовательность
- При любой заметной смене направления синхронизировать это в `docs/status.md` и `docs/roadmap.md`, чтобы не терялась линия выполнения
